...
class OptionsRepository extends \App\Repositories\BaseRepository{

	public function __construct()
    {
		$this->model = new Article();
		$this->model->lang = \App::getLocale();
		$this->model->type = 'option';
    }
	...
	public static function getOptionsByAnchor($anchor)
	{
		return Article::where(['anchor' => $anchor, 'type' => 'option', 'enabled' => 1])->with(['translates'])->first();
	}
