...
use App\Http\Requests\StoreDocumentCategoriesRequest;
...
class DocumentCategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.document-categories.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('admin.document-categories.create', $data);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StoreDocumentCategoriesRequest $request)
    {
        $result = $this->repo->create($request->validated());
        if ($result) {
            $request->session()->flash('success', 'Success');
            return redirect()->route('admin.document-categories.show', ['id' => $result->id]);
        }else{
    ...
    public function show($id)
    {
        ...
        return view('admin.document-categories.show', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.document-categories.edit', $data);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(StoreDocumentCategoriesRequest $request, $id)
    {
        $result = $this->repo->update($id, $request->validated());
        if ($result) {
            $request->session()->flash('success', 'Success');
            return redirect()->route('admin.document-categories.show', ['id' => $id]);
        }else{
            $request->session()->flash('error', 'Error');
            return back();
        }
