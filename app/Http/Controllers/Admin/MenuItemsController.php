...
{
    protected $repo;
    public function __construct(MenuItemsRepository $repo)
    {
        $this->repo = $repo;
    }
    ...
    public function index()
    {
        ...
        return view('admin.menu-items.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('admin.menu-items.create', $data);
    }
    ...
    public function store(StoreMenuItemRequest $request)
    {
        ...
        if ($result) {
            ...
            return redirect()->route('admin.menu-items.show', ['id' => $result->id]);
        }else{
    ...
    public function show($id)
    {
        ...
        return view('admin.menu-items.show', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.menu-items.edit', $data);
    }
    ...
    public function update(StoreMenuItemRequest $request, $id)
    {
        ...
        if ($result) {
            $request->session()->flash('success', 'Success');
            return redirect()->route('admin.menu-items.show', ['id' => $id]);
        }else{
            $request->session()->flash('error', 'Error');
            return back();
        }
