...
class CategoriesController extends Controller
{
    ...
    public function __construct(CategoriesRepository $repo, ArticlesRepository $articlesRepository)
    {
        $this->repo = $repo;
    ...
    public function create()
    {
        $data = [
            ...
            'categories' => $this->articlesRepository->getCategoriesArr()
        ];
    ...
    public function store(StoreCategoriesRequest $request)
    {
        ...
        if ($result) {
            ...
            return redirect()->route('admin.categories.show', ['id' => $result->id]);
        }else{
