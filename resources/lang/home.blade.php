...
@section('additionalCssFiles')
  <style>
    ...
    .rating-bottom .rating-b-item > a {
      ...
      text-align: center;
      border-radius: 8px;
      box-shadow: 0px 4px 20px 0px rgb(110 110 110 / 20%);
      padding: 20px 30px;
    }
      ...
      <div class="modalPageInnerWrap">
        <div class="minContainer">
          <div class="modalPageHead">
            <h1 class="title title-28"><i class="{{$modalPageMenuItem['icon']}}"></i><span>{{$modalPageMenuItem['title']}}</span></h1><a href="#" class="closeModalPage right"><i class="icon-close"></i></a>
...
<a href="https://mailchi.mp/40cd4980cafb/uzbekistan-ministry-of-labor-covid-19-response-webinar" target="_blank">
  <div id="mainBanner">
    <?php if ($mainSlider): ?>
...
<div id="followModal" class="modalPage modalPageLeft">
  <div class="modalPageInnerWrap">
    <div class="minContainer">
      <div class="modalPageHead">
        <h1 class="title title-28"><i class="fa fa-rss"></i><span>{{__('main.Подписатся')}}</span></h1><a href="#" class="closeModalPage right"><i class="icon-close"></i></a>
        <div class="borderedDec grey"></div>
      </div>
      <div class="modalPageBody">
        <div class="row15">
  ...
  <div class="inline-block sidebarItem">
    <div>
      <a href="{{$menu['url']}}" class="bannerBtn sidebarItem" style="line-height: 16px">
        <i class="icon-dots-arrow-min-right" style="font-size: 12px; float: left; width: 10%; align-items: center; display: inline-flex; height: 100%"></i>
        <span style="float: left; width: 80%; align-items: center; display: inline-flex; height: 100%">{{$menu['title']}}</span>
      </a>
    </div>
  </div>
  <?php endforeach ?>
...
<div class="rightSidebar" style="position:absolute; right: 1px;">
  <div class="newsBox" style="padding: 3px 10px">
    ...
    <?php if (isset($lastPressData['title'])): ?>
      <?php if ($lastPressData['content']): ?>
      <div class="newsTitle"><span><a href="{{route('news.show', ['name' => $lastPressData[0]['url']])}}">{{ $lastPressData['title'] }}</a></span></div>
      <div class="newsDate" style="text-align: left"> <i class="icon-dec-1"></i><span>{{ str_limit($lastPressData['created_at'], 10, '') }}</span></div>
      <?php endif ?>
    <?php endif ?>
  </div>
  <hr>
  <div class="newsBox" style="padding: 3px 10px">
    ...
    <div class="newsImage"><a href="{{ $lastTerritorialNews[0]['url'] }}" style="background-image:url('{{ $lastTerritorialNews[0]['image'] }}'); font-size: 18px; font-weight: bold"></a></div>
    <div class="newsTitle"><a href="{{ $lastTerritorialNews[0]['url'] }}">{{ $lastTerritorialNews[0]['title'] }}</a></div>
    <div class="newsDate" style="text-align: left">{!! $lastTerritorialNews[0]['date'] !!}</div>
    <?php else: ?>
    <div class="newsImage"><a href="#" style="background-image:url('{{ asset('/images/siteImage.png') }}');"></a></div>
    <?php endif ?>
  </div>
</div>
  ...
  <div class="mainContainer">
        ...
        <?php if (isset($onlineServices['title'])&&$onlineServices['title']): ?>
          ...
          <?php if ($onlineServices['childs']): ?>
              ...
              <nav>
                <ul>
                  <?php foreach ($onlineServices['childs'] as $index => $child): ?>
                    <li <?= $onlineServices['childs'][0] == $child?'class="active"':"" ?>><a href="{{$index}}">{{$child['title']}}</a></li>
                  <?php endforeach ?>
            ...
            <div class="servicesTabsBodies">
              <?php foreach ($onlineServices['childs'] as $index => $child): ?>
              <div <?= $onlineServices['childs'][0] == $child?'style="display:block;"':"" ?> class="servicesTabsBody servicesTabsBody{{$index}}">
                <?php if ($child['items']): ?>
                  <ul class="onlineServices">
                  <?php foreach ($child['items'] as $item): ?>
                    <li>
    ...
    <div class="newsSection">
      <div class="textCenter sectionTitle">
        <h3 class="title title-22">Статистика</h3>
      </div>
      <div class="dottsBlock"></div>
    </div>
    <?php endif ?>
  </div>
</div>
<div class="mainContainer">
  ...
  <div class="newsBlock">
    <div class="minContainer">
      <div class="newsList">
        <ul>
          ...
          <li>
            <div class="newsBox">
              <div class="newsImage"><a href="{{route('news.show', ['name' => $newsItem->url])}}" style="background-image:url('{{getMedium($newsItem->image)}}');"></a></div>
              <div class="newsTitle"><a href="{{route('news.show', ['name' => $newsItem->url])}}"><span>{{$newsItem->title}}</span></a></div>
    ...
    <div class="allRecords allNews">
      <div class="borderedDec"></div><a href="{{route('news')}}" class="btn0 btn1"><span>{{__('main.Все новости')}}</span><i class="icon-dots-arrow-min-right"></i></a>
    </div>
  </div>
  <?php endif ?>
  <?php endif ?>
            ...
            <div class="my-row">
              <div class="my-col-4">
                <div class="rating-b-item">
                  <a href="#" target="_blank" rel="nofollow" class="rating-hover">
                    <span class="rating-unity">
                      <span class="rating-count" data-counter="408929">408929</span>
                    </span>
                    <span style="font-weight: normal; color: #00598e">Жами кўрсатилган хизматлар</span>
                  </a>
                </div>
              </div>
              <div class="my-col-4">
                <div class="rating-b-item">
                  <a href="#" target="_blank" rel="nofollow" class="rating-hover">
                    <span class="rating-unity">
                      <span class="rating-count" data-counter="146398">146398</span>
                    </span>
                    <span style="font-weight: normal; color: #00598e">Ишга жойлаштириш</span>
                  </a>
                </div>
              </div>
              <div class="my-col-4">
                <div class="rating-b-item">
                  <a href="#" target="_blank" rel="nofollow" class="rating-hover">
                    <span class="rating-unity">
                      <span class="rating-count" data-counter="100579">100579</span>
                    </span>
                    <span style="font-weight: normal; color: #00598e">Жамоат ишига жалб қилиш</span>
                  </a>
                </div>
              </div>
              <div class="my-col-4">
                <div class="rating-b-item">
                  <a href="#" target="_blank" rel="nofollow" class="rating-hover">
                    <span class="rating-unity">
                      <span class="rating-count" data-counter="72920">72920</span>
                    </span>
                    <span style="font-weight: normal; color: #00598e">Ишсизлик нафақаси тайинлаш</span>
                  </a>
                </div>
              </div>
              <div class="my-col-4">
                <div class="rating-b-item">
                  <a href="#" target="_blank" rel="nofollow" class="rating-hover">
                    <span class="rating-unity">
                      <span class="rating-count" data-counter="16339">16339</span>
                    </span>
                    <span style="font-weight: normal; color: #00598e">Субсидия ажратиш</span>
                  </a>
                </div>
              </div>
              <div class="my-col-4">
                <div class="rating-b-item">
                  <a href="#" target="_blank" rel="nofollow" class="rating-hover">
                    <span class="rating-unity">
                      <span class="rating-count" data-counter="72693">72693</span>
                    </span>
                    <span style="font-weight: normal; color: #00598e">Касбга тайёрлашга юбориш</span>
                  </a>
                </div>
              </div>
          ...
          <div class="layout">
                    ...
                    <div class="news2Box">
                      <div class="news2Image">
                        <a href="{{route('news.show', ['name' => $news[0]->url])}}" style="height: 350px">
                          <div style="background-image:url('{{getMedium($news[0]->image)}}'); background-size: auto 100%" class="imgBox"></div>
                          <div class="arrowHover"><img src="{{asset('/images/icons/arrow-ellips.png')}}" alt=""/></div>
                        </a>
                      </div>
                      <div class="news2Title">
                        <a href="{{route('news.show', ['name' => $news[0]->url])}}" style="font-size: 18px; font-weight: bold">{{$news[0]->title}}</a>
                      </div>
                      <div class="news2Footer">
                        <?php $date = new \DateTime($news[0]->date); ?>
                        <div class="newsDate left"> <i class="icon-dec-1"></i><span><b>{{$date->format('d')}}</b>.{{$date->format('m.Y')}}</span></div>
                      </div>
                    </div>
                          ...
                          <div class="news2Box">
                            <div class="news2Image">
                              <a href="{{route('news.show', ['name' => $newsItem->url])}}" style="height: 170px">
                                <div style="background-image:url('{{getMedium($newsItem->image)}}'); background-size: auto 100%" class="imgBox"></div>
                                <div class="arrowHover"><img src="{{asset('/images/icons/arrow-ellips.png')}}" alt=""/></div>
                              </a>
                            </div>
                            <div class="news2Title">
            ...
            <div class="page photoGalleryTabs-page">
              <div class="page-contents">
                ...
                <a class="example-image-link" href="{{getMedium($photo->image)}}" data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
        ...
        <ul class="sliderSites owl-carousel owl-theme">
          ...
          <li>
            <div class="infographicItem">
              <a class="example-image-link" href="{{getMedium($infographic->image)}}" data-lightbox="example-set" data-title="Click the right half of the image to move forward.">
...
// Add data
      chart.data = [ {
        "country": "Иқтисодий фаол аҳоли",
        "litres": 14926.7
      }, {
        "country": "Жами бандлар",
        "litres": 13397.5
      }, {
        "country": "Расмий секторда бандлар",
        "litres": 5706.8
      }, {
        "country": "Норасмий секторда бандлар",
        "litres": 6102.0
      }, {
        "country": "Республикадан ташқарига чиқиб кетганлар",
        "litres": 1588.7
      }, {
        "country": "Ишга жойлаштиришга муҳтож шахслар",
        "litres": 1529.2
      }, {
        "country": "Ишсизлик даражаси(%)",
        "litres": 10.2
      }, {
        "country": "Иқтисодий  нофаол аҳоли",
        "litres": 4350.7
      }, {
        "country": "Жами меҳнат ресурси",
        "litres": 19277.4
      }, {
        "country": "Ўртача аҳоли сони",
        "litres": 34627.2
      }
      ];
