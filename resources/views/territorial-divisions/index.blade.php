...
@section('title', __('main.Территориальные подразделения'))
  ...
  <div class="mainContainer">
    <div class="contentBlock firstContent">
      <div class="middleContainer">
        <div class="pageHead">
          <h2 class="title title-24">{{__('main.Территориальные подразделения')}}</h2>
                        ...
                        <div class="personalCard">
                          ...
                          <div class="clearFix">
                            <div class="minButtons minButtons2 left">
                              <a href="{{route('territorial-divisions.structure',['id' => $employee->id])}}" target="_blank">{{__('main.Структура')}}</a>
                              <a href="{{route('territorial-divisions.position',['id' => $employee->id])}}" target="_blank">{{__('main.Положение')}}</a>
                            </div>
