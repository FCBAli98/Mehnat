            ...
            <div class="contentItems">
              <div class="breadcrumbs1">
                <ul>
                  ...
                  <li>
                    <a href="{{route('territorial-divisions.index')}}">{{__('main.Территориальные подразделения')}}</a>
                  </li>
                  <li>
                    {{$model->position}}
                  </li>
              ...
              <div class="staticPageHead">
                <h2 class="title title-28">{{__('main.Структура')}}</h2>
                <div class="personalCardName">{{$model->position}}</div>
              </div>
              <div class="staticPageContent"><?= $model->description ?></div>
