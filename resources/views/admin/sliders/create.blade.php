...
@section('title', 'Слайдеры - Добавление')
...
<div class="clearfix">
    <div class="pull-left">
        <div class="btn-group group-control">
          <a href="{{ route('admin.sliders.index') }}" class="btn btn-default">{{__('main.Back')}}</a>
        </div>
    </div>
</div>
<br>
<div class="row">
  <div class="col-md-4">
    <?php echo Form::model($model,['url' => route('admin.sliders.store'), 'method' => 'post']) ?>
