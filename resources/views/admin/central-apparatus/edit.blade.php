...
@section('title', 'Центральный аппарат - Редактирование')
...
<div class="clearfix">
    <div class="pull-left">
        <div class="btn-group group-control">
          ...
          <a href="{{ route('admin.central-apparatus.show', ['id' => $model->id]) }}" class="btn btn-default">{{__('main.Show')}}</a>
          <a href="{{ route('admin.central-apparatus.create') }}" class="btn btn-default">{{__('main.add_new')}}</a>
        </div>
    </div>
</div>
<br>
    <?php echo Form::model($model, ['url' => route('admin.central-apparatus.update',['id' => $model->id]), 'method' => 'PUT', 'files' => true]) ?>
