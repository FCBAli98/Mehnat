...
@section('title', 'Категории сотрудников - Редактирование')
...
<div class="clearfix">
    <div class="pull-left">
        <div class="btn-group group-control">
          ...
          <a href="{{ route('admin.employee-categories.show', ['id' => $model->id]) }}" class="btn btn-default">{{__('main.Show')}}</a>
...
<div class="row">
  <div class="col-md-12">
    ...
    <?php echo Form::model($model, ['url' => route('admin.employee-categories.update',['id' => $model->id]), 'method' => 'PUT']) ?>
