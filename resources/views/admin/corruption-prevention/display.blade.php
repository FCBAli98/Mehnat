...
@section('title', 'Предотвращение коррупции')

@section('content')
<div class="pull-right">
  <br>
  <div class="form-group">
    Перейти: <a href="{{route('corruption-prevention')}}" target="_blank">{{route('corruption-prevention', [], false)}}</a>
  </div>
</div>
<h2>Предотвращение коррупции</h2>
<hr>
    <?php echo Form::model($model,['url' => route('admin.corruption-prevention.submit'), 'method' => 'post', 'files' => true]) ?>
