...
@section('title', 'Подведомственные организации - Добавление')
...
<div class="clearfix">
    <div class="pull-left">
        <div class="btn-group group-control">
          <a href="{{ route('admin.subordinate-organizations.index') }}" class="btn btn-default">{{__('main.Back')}}</a>
        </div>
    </div>
</div>
<br>
    <?php echo Form::model($model,['url' => route('admin.subordinate-organizations.store'), 'method' => 'post', 'files' => true]) ?>
